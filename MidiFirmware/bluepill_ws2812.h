...
// WS2812 timing
const unsigned int CLOCK_FREQUENCY_MHZ = 72;
#define   C_NS(_NS) (_NS*CLOCK_FREQUENCY_MHZ/1000)
#define T0H C_NS(400)
#define T1H C_NS(800)
#define THL C_NS(1250)

// pixel data buffer structure
union pixel 
{ struct { uint8_t g; uint8_t r; uint8_t b; } rgb;
